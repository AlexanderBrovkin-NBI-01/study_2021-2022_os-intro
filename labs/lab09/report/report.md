...
5.2. Вставил эту строку в конец файла (C-y).(рис. [-@fig:005])
...
![рис.9](image/14.png){ #fig:009 width=70% }
...
9.3. Вышел из режима поиска, нажав C-g.(рис. [-@fig:019])
...
![рис.21](image/28.png){ #fig:021 width=70% }
