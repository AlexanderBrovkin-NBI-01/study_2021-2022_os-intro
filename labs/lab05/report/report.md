...
2.8. Создал и переместил каталог ~/newdir в каталог ~/ski.plases командами mkdir и  mv и назвал его plans командой mv. (см.рис. [-@fig:004])


![Продолжнаю выполнять примеры](image/6.png){ #fig:004 width=70% }
